        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.aggressiveItemStacking, newVal -> ZOptions.aggressiveItemStacking = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.particleBudget, newVal -> ZOptions.particleBudget = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.fluidRenderingOpt, newVal -> ZOptions.fluidRenderingOpt = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.fastCrystals, newVal -> ZOptions.fastCrystals = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.renderEntityShadows, newVal -> ZOptions.renderEntityShadows = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                ...
                .option(Option.<Boolean>createBuilder()
                    ...
                    .binding(true, () -> ZOptions.enableEntityPushing, newVal -> ZOptions.enableEntityPushing = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.literal("Fast Math"))
                    .description(OptionDescription.of(Component.literal("Improves calculations for game")))
                    .binding(true, () -> ZOptions.fastMath, newVal -> ZOptions.fastMath = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .option(Option.<Boolean>createBuilder()
                    .name(Component.literal("End crystals animation"))
                    .description(OptionDescription.of(Component.literal("Simplifies the rendering math for End Crystals to prevent lag spikes during combat. Enable if you want a static crystal.")))
                    .binding(true, () -> ZOptions.crystalAnimation, newVal -> ZOptions.crystalAnimation = newVal)
                    .controller(TickBoxControllerBuilder::create)
                    .build())
                .build())
